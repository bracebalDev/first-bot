...
from src.first_bot.config import INPUT_PATH
...
def csv_con_errores(temp_input_dir):
    ...
    df = pd.DataFrame([
        {
            "First Name": "", "Last Name": "", "Company Name": "X",
            "Role in Company": "X", "Address": "X",
            "Email": "no-email", "Phone Number": "X",
            "tipo_solicitud": "soporte", "fecha": "no-fecha",
            "prioridad": "invalida", "identificador": "ERR-001",
            "descripcion": "X", "estado": "invalido",
        },
        {
            "First Name": "Ana", "Last Name": "García",
            "Company Name": "DataCorp", "Role in Company": "Manager",
            "Address": "Calle 5", "Email": "ana@example.com",
            "Phone Number": "+1-555-9999",
            "tipo_solicitud": "reclamo", "fecha": "2024-01-10",
            "prioridad": "alta", "identificador": "SOL-003",
            "descripcion": "Reclamo válido", "estado": "pendiente",
        },
    ])
    df.to_csv(path, index=False)
    return path
